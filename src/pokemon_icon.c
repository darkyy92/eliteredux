...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_GIRATINA_ORIGIN_FORME] = gMonIcon_Giratina_Origin_Forme,
    [SPECIES_PALKIA_ORIGIN_FORME] = gMonIcon_Palkia_Origin_Forme,
    [SPECIES_DIALGA_ORIGIN_FORME] = gMonIcon_Dialga_Origin_Forme,
    [SPECIES_ROTOM_WASH_MODE] = gMonIcon_Rotom_Wash_Mode,
    [SPECIES_ROTOM_FAN_MODE] = gMonIcon_Rotom_Fan_Mode,
    [SPECIES_ROTOM_HEAT_MODE] = gMonIcon_Rotom_Heat_Mode,
    [SPECIES_ROTOM_FROST_MODE] = gMonIcon_Rotom_Frost_Mode,
    [SPECIES_ROTOM_MOW_MODE] = gMonIcon_Rotom_Mow_Mode,
    ...
    [SPECIES_URSALUNA_MOONBLOOD] = gMonIcon_Ursaluna_Moonblood,
    ...
    [SPECIES_TEMP_MEGA9]  = gMonIcon_QuestionMark,
    [SPECIES_TEMP_MEGA10]  = gMonIcon_QuestionMark,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_KINGAMBIT] = 2,
    [SPECIES_GREAT_TUSK] = 2,
    [SPECIES_SCREAM_TAIL] = 2,
    [SPECIES_BRUTE_BONNET] = 2,
    [SPECIES_FLUTTER_MANE] = 2,
    [SPECIES_SLITHER_WING] = 2,
    [SPECIES_SANDY_SHOCKS] = 2,
    [SPECIES_IRON_TREADS] = 2,
    [SPECIES_IRON_BUNDLE] = 2,
    [SPECIES_IRON_HANDS] = 2,
    [SPECIES_IRON_JUGULIS] = 2,
    [SPECIES_IRON_MOTH] = 2,
    [SPECIES_IRON_THORNS] = 2,
    [SPECIES_FRIGIBAX] = 2,
    [SPECIES_ARCTIBAX] = 2,
    ...
    [SPECIES_TING_LU] = 2,
    [SPECIES_CHI_YU] = 2,
    [SPECIES_ROARING_MOON] = 2,
    [SPECIES_IRON_VALIANT] = 2,
    [SPECIES_KORAIDON] = 2,
    [SPECIES_MIRAIDON] = 2,
    [SPECIES_WALKING_WAKE] = 2,
    [SPECIES_IRON_LEAVES] = 2,
    [SPECIES_DIPPLIN] = 2,
    [SPECIES_POLTCHAGEIST] = 2,
    [SPECIES_SINISTCHA] = 2,
    [SPECIES_OKIDOGI] = 2,
    [SPECIES_MUNKIDORI] = 2,
    [SPECIES_FEZANDIPITI] = 2,
    [SPECIES_OGERPON] = 2,
    [SPECIES_ENAMORUS_THERIAN] = 2,
    [SPECIES_GIRATINA_ORIGIN_FORME] = 2,
    [SPECIES_PALKIA_ORIGIN_FORME] = 2,
    [SPECIES_DIALGA_ORIGIN_FORME] = 2,
    [SPECIES_ROTOM_WASH_MODE] = 2,
    [SPECIES_ROTOM_FAN_MODE] = 2,
    [SPECIES_ROTOM_HEAT_MODE] = 2,
    [SPECIES_ROTOM_FROST_MODE] = 2,
    [SPECIES_ROTOM_MOW_MODE] = 2,
    [SPECIES_OGERPON_HEARTHFLAME_MASK] = 2,
    [SPECIES_OGERPON_CORNERSTONE_MASK] = 2,
    [SPECIES_OGERPON_WELLSPRING_MASK] = 2,
    [SPECIES_SQUAWKABILLY_WHITE_PLUMAGE] = 2,
    [SPECIES_SQUAWKABILLY_YELLOW_PLUMAGE] = 2,
    [SPECIES_SQUAWKABILLY_BLUE_PLUMAGE] = 2,
    [SPECIES_SQUAWKABILLY_GREEN_PLUMAGE] = 2,
    [SPECIES_TATSUGIRI_DROOPY] = 2,
    [SPECIES_TATSUGIRI_STRETCHY] = 2,
    [SPECIES_TATSUGIRI_CURLY] = 2,
    [SPECIES_MAUSHOLD_FOUR] = 2,
    [SPECIES_DUDUNSPARCE_THREE_SEGMENT] = 2,
    [SPECIES_PALAFIN_HERO] = 2,
    [SPECIES_URSALUNA_MOONBLOOD] = 2,
    [SPECIES_TAUROS_PALDEAN_COMBAT_BREED] = 2,
    [SPECIES_TAUROS_PALDEAN_BLAZE_BREED] = 2,
    [SPECIES_TAUROS_PALDEAN_AQUA_BREED] = 2,
    [SPECIES_DECIDUEYE_HISUIAN] = 2,
    [SPECIES_AVALUGG_HISUIAN] = 2,
    [SPECIES_GOODRA_HISUIAN] = 2,
    [SPECIES_SLIGGOO_HISUIAN] = 2,
    [SPECIES_BRAVIARY_HISUIAN] = 2,
    [SPECIES_ZORUA_HISUIAN] = 2,
    [SPECIES_LILLIGANT_HISUIAN] = 2,
    [SPECIES_SAMUROTT_HISUIAN] = 2,
    [SPECIES_SNEASEL_HISUIAN] = 2,
    [SPECIES_TYPHLOSION_HISUIAN] = 2,
    [SPECIES_ELECTRODE_HISUIAN] = 2,
    [SPECIES_VOLTORB_HISUIAN] = 2,
    [SPECIES_ARCANINE_HISUIAN] = 2,
    [SPECIES_GROWLITHE_HISUIAN] = 2,
    ...
    [SPECIES_TEMP_MEGA9]   = 0,
    [SPECIES_TEMP_MEGA10]  = 0,
