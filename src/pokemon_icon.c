...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_SPECTRIER] = 0,
    [SPECIES_CALYREX] = 0,
    [SPECIES_REUNICLUS_REDUX] = 2,
    [SPECIES_SOLOSIS_REDUX] = 2,
    [SPECIES_MACHAMP_MEGA_REDUX] = 2,
    [SPECIES_MACHAMP_REDUX] = 2,
    [SPECIES_MACHOKE_REDUX] = 2,
    [SPECIES_MACHOP_REDUX] = 2,
    [SPECIES_UXIE_REDUX] = 2,
    [SPECIES_MESPRIT_REDUX] = 2,
    [SPECIES_AZELF_REDUX] = 2,
    [SPECIES_FLOATZEL_REDUX] = 2,
    [SPECIES_BUIZEL_REDUX] = 2,
    [SPECIES_MAGCARGO_REDUX] = 2,
    [SPECIES_SLUGMA_REDUX] = 2,
    [SPECIES_SIMISEAR_REDUX] = 2,
    [SPECIES_PANSEAR_REDUX] = 2,
    [SPECIES_SIMISAGE_REDUX] = 2,
    [SPECIES_PANSAGE_REDUX] = 2,
