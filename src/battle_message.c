...
static const u8 sText_BattlerAbilityWindRiderActivated[] = _("{B_ACTIVE_NAME_WITH_PREFIX}'s Wind Rider raised\nits Attack!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
	...
	[STRINGID_WINDRIDERACTIVATED - 12] = sText_BattlerAbilityWindRiderActivated,
