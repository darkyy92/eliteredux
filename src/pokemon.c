...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_GIRATINA_ORIGIN_FORME - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_PALKIA_ORIGIN_FORME - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DIALGA_ORIGIN_FORME - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ROTOM_WASH_MODE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ROTOM_FAN_MODE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ROTOM_HEAT_MODE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ROTOM_FROST_MODE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_ROTOM_MOW_MODE - 1] = ANIM_V_SQUISH_AND_BOUNCE,
