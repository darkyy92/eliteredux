...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_TYRANITAR_MEGA_REDUX_2] = BACK_ANIM_H_SLIDE,
    [SPECIES_TYRANITAR_REDUX_2] = BACK_ANIM_H_SLIDE,
    [SPECIES_PUPITAR_REDUX_2] = BACK_ANIM_H_SLIDE,
    [SPECIES_LARVITAR_REDUX_2] = BACK_ANIM_H_SLIDE,
    [SPECIES_SCIZOR_REDUX] = BACK_ANIM_H_SLIDE,
    [SPECIES_SCIZOR_MEGA_REDUX] = BACK_ANIM_H_SLIDE,
