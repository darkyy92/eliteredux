const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_URSALUNA_MOONBLOOD] = sUrsalunaMoonbloodLevelUpLearnset,
    [SPECIES_PALAFIN_HERO] = sPalafinHeroLevelUpLearnset,
    [SPECIES_DUDUNSPARCE_THREE_SEGMENT] = sDudunsparceThreeSegmentLevelUpLearnset,
    ...
    [SPECIES_SQUAWKABILLY_GREEN_PLUMAGE] = sSquawkabillyGreenPlumageLevelUpLearnset,
    [SPECIES_SQUAWKABILLY_BLUE_PLUMAGE] = sSquawkabillyBluePlumageLevelUpLearnset,
    [SPECIES_SQUAWKABILLY_YELLOW_PLUMAGE] = sSquawkabillyYellowPlumageLevelUpLearnset,
    [SPECIES_SQUAWKABILLY_WHITE_PLUMAGE] = sSquawkabillyWhitePlumageLevelUpLearnset,
    [SPECIES_DIALGA_ORIGIN] = sDialgaOriginFormeLevelUpLearnset,
    [SPECIES_PALKIA_ORIGIN] = sPalkiaOriginFormeLevelUpLearnset,
    [SPECIES_ENAMORUS_THERIAN] = sEnamorusTherianLevelUpLearnset,
    [SPECIES_OGERPON_HEARTHFLAME_MASK] = sOgerponHearthflameMaskLevelUpLearnset,
    [SPECIES_OGERPON_CORNERSTONE_MASK] = sOgerponCornerstoneMaskLevelUpLearnset,
    [SPECIES_OGERPON_WELLSPRING_MASK] = sOgerponWellspringMaskLevelUpLearnset,
    ...
    [SPECIES_LARVITAR_REDUX_2] = sLarvitar_Redux_2LevelUpLearnset,
    [SPECIES_PUPITAR_REDUX_2] = sPupitar_Redux_2LevelUpLearnset,
    [SPECIES_TYRANITAR_REDUX_2] = sTyranitar_Redux_2LevelUpLearnset,
    [SPECIES_TYRANITAR_MEGA_REDUX_2] = sTyranitar_Mega_Redux_2LevelUpLearnset,
