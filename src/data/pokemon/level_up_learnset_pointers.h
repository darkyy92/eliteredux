const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_QWILFISH_HISUIAN] = sQwilfish_HisuianLevelUpLearnset,
    [SPECIES_GROWLITHE_HISUIAN] = sGrowlithe_HisuianLevelUpLearnset,
    [SPECIES_ARCANINE_HISUIAN] = sArcanine_HisuianLevelUpLearnset,
    [SPECIES_VOLTORB_HISUIAN] = sVoltorb_HisuianLevelUpLearnset,
    [SPECIES_ELECTRODE_HISUIAN] = sElectrode_HisuianLevelUpLearnset,
    [SPECIES_TYPHLOSION_HISUIAN] = sTyphlosion_HisuianLevelUpLearnset,
    [SPECIES_SNEASEL_HISUIAN] = sSneasel_HisuianLevelUpLearnset,
    [SPECIES_SAMUROTT_HISUIAN] = sSamurott_HisuianLevelUpLearnset,
    [SPECIES_LILLIGANT_HISUIAN] = sLilligant_HisuianLevelUpLearnset,
    [SPECIES_ZORUA_HISUIAN] = sZorua_HisuianLevelUpLearnset,
    [SPECIES_BRAVIARY_HISUIAN] = sBraviary_HisuianLevelUpLearnset,
    ...
    [SPECIES_TAUROS_PALDEAN_AQUA_BREED] = sTauros_Paldean_Aqua_BreedLevelUpLearnset,
    [SPECIES_TAUROS_PALDEAN_BLAZE_BREED] = sTauros_Paldean_Blaze_BreedLevelUpLearnset,
    [SPECIES_TAUROS_PALDEAN_COMBAT_BREED] = sTauros_Paldean_Combat_BreedLevelUpLearnset,
    [SPECIES_URSALUNA_MOONBLOOD] = sUrsaluna_MoonbloodLevelUpLearnset,
    ...
    [SPECIES_TATSUGIRI_STRETCHY] = sTatsugiri_StretchyLevelUpLearnset,
    [SPECIES_TATSUGIRI_DROOPY] = sTatsugiri_DroopyLevelUpLearnset,
    [SPECIES_SQUAWKABILLY_GREEN_PLUMAGE] = sSquawkabilly_Green_PlumageLevelUpLearnset,
    [SPECIES_SQUAWKABILLY_BLUE_PLUMAGE] = sSquawkabilly_Blue_PlumageLevelUpLearnset,
    [SPECIES_SQUAWKABILLY_YELLOW_PLUMAGE] = sSquawkabilly_Yellow_PlumageLevelUpLearnset,
    [SPECIES_SQUAWKABILLY_WHITE_PLUMAGE] = sSquawkabilly_White_PlumageLevelUpLearnset,
    [SPECIES_ROTOM_MOW_MODE] = sRotom_Mow_ModeLevelUpLearnset,
    [SPECIES_ROTOM_FROST_MODE] = sRotom_Frost_ModeLevelUpLearnset,
    [SPECIES_ROTOM_HEAT_MODE] = sRotom_Heat_ModeLevelUpLearnset,
    [SPECIES_ROTOM_FAN_MODE] = sRotom_Fan_ModeLevelUpLearnset,
    [SPECIES_ROTOM_WASH_MODE] = sRotom_Wash_ModeLevelUpLearnset,
    [SPECIES_DIALGA_ORIGIN_FORME] = sDialga_Origin_FormeLevelUpLearnset,
    [SPECIES_PALKIA_ORIGIN_FORME] = sPalkia_Origin_FormeLevelUpLearnset,
    [SPECIES_GIRATINA_ORIGIN_FORME] = sGiratina_Origin_FormeLevelUpLearnset,
    [SPECIES_ENAMORUS_THERIAN] = sEnamorus_TherianLevelUpLearnset,
    [SPECIES_OGERPON_HEARTHFLAME_MASK] = sOgerpon_Hearthflame_MaskLevelUpLearnset,
    [SPECIES_OGERPON_CORNERSTONE_MASK] = sOgerpon_Cornerstone_MaskLevelUpLearnset,
    [SPECIES_OGERPON_WELLSPRING_MASK] = sOgerpon_Wellspring_MaskLevelUpLearnset,
    ...
    [SPECIES_IRON_LEAVES] = sIron_LeavesLevelUpLearnset,
    [SPECIES_WALKING_WAKE] = sWalking_WakeLevelUpLearnset,
    ...
    [SPECIES_ABRA_REDUX] = sAbra_ReduxLevelUpLearnset,
    [SPECIES_KADABRA_REDUX] = sKadabra_ReduxLevelUpLearnset,
    [SPECIES_ALAKAZAM_REDUX] = sAlakazam_ReduxLevelUpLearnset,
    [SPECIES_ALAKAZAM_MEGA_REDUX] = sAlakazam_ReduxLevelUpLearnset,
    [SPECIES_WEEDLE_REDUX] = sWeedle_ReduxLevelUpLearnset,
    [SPECIES_KAKUNA_REDUX] = sKakuna_ReduxLevelUpLearnset,
    [SPECIES_BEEDRILL_REDUX] = sBeedrill_ReduxLevelUpLearnset,
    [SPECIES_BEEDRILL_MEGA_REDUX] = sBeedrill_ReduxLevelUpLearnset,
    [SPECIES_STUFFUL_REDUX] = sStufful_ReduxLevelUpLearnset,
    [SPECIES_BEWEAR_REDUX] = sBewear_ReduxLevelUpLearnset,
    [SPECIES_PANPOUR_REDUX] = sPanpour_ReduxLevelUpLearnset,
    [SPECIES_SIMIPOUR_REDUX] = sSimipour_ReduxLevelUpLearnset,
    [SPECIES_PANSAGE_REDUX] = sPansage_ReduxLevelUpLearnset,
    [SPECIES_SIMISAGE_REDUX] = sSimisage_ReduxLevelUpLearnset,
    [SPECIES_PANSEAR_REDUX] = sPansear_ReduxLevelUpLearnset,
    [SPECIES_SIMISEAR_REDUX] = sSimisear_ReduxLevelUpLearnset,
    [SPECIES_SLUGMA_REDUX] = sSlugma_ReduxLevelUpLearnset,
    [SPECIES_MAGCARGO_REDUX] = sMagcargo_ReduxLevelUpLearnset,
    [SPECIES_BUIZEL_REDUX] = sBuizel_ReduxLevelUpLearnset,
    [SPECIES_FLOATZEL_REDUX] = sFloatzel_ReduxLevelUpLearnset,
    [SPECIES_AZELF_REDUX] = sAzelf_ReduxLevelUpLearnset,
    [SPECIES_MESPRIT_REDUX] = sMesprit_ReduxLevelUpLearnset,
    [SPECIES_UXIE_REDUX] = sUxie_ReduxLevelUpLearnset,
    [SPECIES_MACHOP_REDUX] = sMachop_ReduxLevelUpLearnset,
    [SPECIES_MACHOKE_REDUX] = sMachoke_ReduxLevelUpLearnset,
    [SPECIES_MACHAMP_REDUX] = sMachamp_ReduxLevelUpLearnset,
    [SPECIES_MACHAMP_MEGA_REDUX] = sMachamp_ReduxLevelUpLearnset,
    [SPECIES_SKARMORY_MEGA_REDUX] = sSkarmory_ReduxLevelUpLearnset,
    [SPECIES_SKARMORY_REDUX] = sSkarmory_ReduxLevelUpLearnset,
    [SPECIES_SOLOSIS_REDUX] = sSolosis_ReduxLevelUpLearnset,
    [SPECIES_DUOSION_REDUX] = sDuosion_ReduxLevelUpLearnset,
    ...
    [SPECIES_ARCANINE_MEGA_REDUX] = sArcanine_ReduxLevelUpLearnset,
    [SPECIES_WHISMUR_REDUX] = sWhismur_ReduxLevelUpLearnset,
    [SPECIES_LOUDRED_REDUX] = sLoudred_ReduxLevelUpLearnset,
    [SPECIES_EXPLOUD_REDUX] = sExploud_ReduxLevelUpLearnset,
    [SPECIES_GIBLE_REDUX] = sGible_ReduxLevelUpLearnset,
    [SPECIES_GABITE_REDUX] = sGabite_ReduxLevelUpLearnset,
    [SPECIES_GARCHOMP_REDUX] = sGarchomp_ReduxLevelUpLearnset,
    [SPECIES_GARCHOMP_MEGA_REDUX] = sGarchomp_ReduxLevelUpLearnset,
    [SPECIES_DEINO_REDUX] = sDeino_ReduxLevelUpLearnset,
    [SPECIES_ZWEILOUS_REDUX] = sZweilous_ReduxLevelUpLearnset,
    [SPECIES_HYDREIGON_REDUX] = sHydreigon_ReduxLevelUpLearnset,
    [SPECIES_PAWNIARD_REDUX] = sPawniard_ReduxLevelUpLearnset,
    [SPECIES_BISHARP_REDUX] = sBisharp_ReduxLevelUpLearnset,
    [SPECIES_MAWILE_REDUX] = sMawile_ReduxLevelUpLearnset,
    [SPECIES_MAWILE_MEGA_REDUX] = sMawile_ReduxLevelUpLearnset,
    [SPECIES_SABLEYE_REDUX] = sSableye_ReduxLevelUpLearnset,
    [SPECIES_SABLEYE_MEGA_REDUX] = sSableye_ReduxLevelUpLearnset,
    [SPECIES_HOUNDOUR_REDUX] = sHoundour_ReduxLevelUpLearnset,
    [SPECIES_HOUNDOOM_REDUX] = sHoundoom_ReduxLevelUpLearnset,
    [SPECIES_HOUNDOOM_MEGA_REDUX] = sHoundoom_ReduxLevelUpLearnset,
    [SPECIES_FROSLASS_MEGA] = sFroslassLevelUpLearnset,
    [SPECIES_SCRAFTY_MEGA] = sScraftyLevelUpLearnset,
    [SPECIES_DODUO_REDUX] = sDoduo_ReduxLevelUpLearnset,
    [SPECIES_DODRIO_REDUX] = sDodrio_ReduxLevelUpLearnset,
    // Megas
