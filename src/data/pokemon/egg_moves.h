...
const u16 gEggMoves[] = {
    ...
    egg_moves(FLOATZEL_REDUX,
        MOVE_SPLASH,
        MOVE_FIRE_PUNCH,
        MOVE_ICE_PUNCH,
        MOVE_THUNDER_PUNCH),

    egg_moves(AZELF_REDUX,
        MOVE_SPLASH,
        MOVE_FIRE_PUNCH,
        MOVE_ICE_PUNCH,
        MOVE_THUNDER_PUNCH),

    egg_moves(MESPRIT_REDUX,
        MOVE_SPLASH,
        MOVE_FIRE_PUNCH,
        MOVE_ICE_PUNCH,
        MOVE_THUNDER_PUNCH),

    egg_moves(UXIE_REDUX,
        MOVE_SPLASH,
        MOVE_FIRE_PUNCH,
        MOVE_ICE_PUNCH,
        MOVE_THUNDER_PUNCH),
    ...
    egg_moves(MACHOKE_REDUX,
        MOVE_SPLASH,
        MOVE_FIRE_PUNCH,
        MOVE_ICE_PUNCH,
        MOVE_THUNDER_PUNCH),

    egg_moves(MACHAMP_REDUX,
        MOVE_SPLASH,
        MOVE_FIRE_PUNCH,
        MOVE_ICE_PUNCH,
        MOVE_THUNDER_PUNCH),

    egg_moves(MACHAMP_MEGA_REDUX,
        MOVE_SPLASH,
        MOVE_FIRE_PUNCH,
        MOVE_ICE_PUNCH,
        MOVE_THUNDER_PUNCH),
