...
#define EXP_FAST(n) EXP_SLOW(n) //((4 * CUBE(n)) / 5) // (4 * (n)^3) / 5
#define EXP_MEDIUM_FAST(n) EXP_SLOW(n) //(CUBE(n)) // (n)^3
#define EXP_MEDIUM_SLOW(n) EXP_SLOW(n) //((6 * CUBE(n)) / 5 - (15 * SQUARE(n)) + (100 * n) - 140)    // (6 * (n)^3) / 5 - (15 * (n)^2) + (100 * n) - 140
#define EXP_ERRATIC(n) EXP_SLOW(n) //                                      \
     (n <= 50) ? ((100 - n) * CUBE(n) /  50)                \
    :(n <= 68) ? ((150 - n) * CUBE(n) / 100)                \
    :(n <= 98) ? (((1911 - 10 * n) / 3) * CUBE(n) / 500)    \
    :            ((160 - n) * CUBE(n) / 100)
#define EXP_FLUCTUATING(n) EXP_SLOW(n) //                                  \
