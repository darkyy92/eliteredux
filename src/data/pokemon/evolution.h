const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PAWMO]                 = {{EVO_LEVEL, 16, SPECIES_PAWMOT}},
    ...
    [SPECIES_TADBULB]               = {{EVO_LEVEL, 26, SPECIES_BELLIBOLT}}, //To Change
    ...
    [SPECIES_GIMMIGHOUL]            = {{EVO_LEVEL, 16, SPECIES_GHOLDENGO}},
    [SPECIES_POLTCHAGEIST]          = {{EVO_LEVEL, 16, SPECIES_SINISTCHA}}, //To Change
    //Alternate Forms
