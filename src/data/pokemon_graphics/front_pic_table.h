const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(GIRATINA_ORIGIN_FORME, gMonFrontPic_Giratina_Origin_Forme),
    SPECIES_SPRITE(PALKIA_ORIGIN_FORME, gMonFrontPic_Palkia_Origin_Forme),
    SPECIES_SPRITE(DIALGA_ORIGIN_FORME, gMonFrontPic_Dialga_Origin_Forme),
    SPECIES_SPRITE(ROTOM_WASH_MODE, gMonFrontPic_Rotom_Wash_Mode),
    SPECIES_SPRITE(ROTOM_FAN_MODE, gMonFrontPic_Rotom_Fan_Mode),
    SPECIES_SPRITE(ROTOM_HEAT_MODE, gMonFrontPic_Rotom_Heat_Mode),
    SPECIES_SPRITE(ROTOM_FROST_MODE, gMonFrontPic_Rotom_Frost_Mode),
    SPECIES_SPRITE(ROTOM_MOW_MODE, gMonFrontPic_Rotom_Mow_Mode),
