const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(DODRIO_REDUX, gMonFrontPic_Dodrio_Redux),
    SPECIES_SPRITE(DODUO_REDUX, gMonFrontPic_Doduo_Redux),
    SPECIES_SPRITE(SCRAFTY_MEGA, gMonFrontPic_Scrafty_Mega),
    SPECIES_SPRITE(FROSLASS_MEGA, gMonFrontPic_Froslass_Mega),
    SPECIES_SPRITE(HOUNDOOM_MEGA_REDUX, gMonFrontPic_Houndoom_Mega_Redux),
    SPECIES_SPRITE(HOUNDOOM_REDUX, gMonFrontPic_Houndoom_Redux),
    SPECIES_SPRITE(HOUNDOUR_REDUX, gMonFrontPic_Houndour_Redux),
    SPECIES_SPRITE(SABLEYE_MEGA_REDUX, gMonFrontPic_Sableye_Mega_Redux),
    SPECIES_SPRITE(SABLEYE_REDUX, gMonFrontPic_Sableye_Redux),
    SPECIES_SPRITE(MAWILE_MEGA_REDUX, gMonFrontPic_Mawile_Mega_Redux),
    SPECIES_SPRITE(MAWILE_REDUX, gMonFrontPic_Mawile_Redux),
    SPECIES_SPRITE(BISHARP_REDUX, gMonFrontPic_Bisharp_Redux),
    SPECIES_SPRITE(PAWNIARD_REDUX, gMonFrontPic_Pawniard_Redux),
    SPECIES_SPRITE(HYDREIGON_REDUX, gMonFrontPic_Hydreigon_Redux),
    SPECIES_SPRITE(ZWEILOUS_REDUX, gMonFrontPic_Zweilous_Redux),
    SPECIES_SPRITE(DEINO_REDUX, gMonFrontPic_Deino_Redux),
    SPECIES_SPRITE(GARCHOMP_MEGA_REDUX, gMonFrontPic_Garchomp_Mega_Redux),
    SPECIES_SPRITE(GARCHOMP_REDUX, gMonFrontPic_Garchomp_Redux),
    SPECIES_SPRITE(GABITE_REDUX, gMonFrontPic_Gabite_Redux),
    SPECIES_SPRITE(GIBLE_REDUX, gMonFrontPic_Gible_Redux),
    SPECIES_SPRITE(EXPLOUD_REDUX, gMonFrontPic_Exploud_Redux),
    SPECIES_SPRITE(LOUDRED_REDUX, gMonFrontPic_Loudred_Redux),
    SPECIES_SPRITE(WHISMUR_REDUX, gMonFrontPic_Whismur_Redux),
    SPECIES_SPRITE(ARCANINE_MEGA_REDUX, gMonFrontPic_Arcanine_Mega_Redux),
    SPECIES_SPRITE(ARCANINE_REDUX, gMonFrontPic_Arcanine_Redux),
    SPECIES_SPRITE(GROWLITHE_REDUX, gMonFrontPic_Growlithe_Redux),
    SPECIES_SPRITE(SKARMORY_MEGA_REDUX, gMonFrontPic_Skarmory_Mega_Redux),
    SPECIES_SPRITE(BEEDRILL_MEGA_REDUX, gMonFrontPic_Beedrill_Mega_Redux),
    SPECIES_SPRITE(SOLOSIS_REDUX, gMonFrontPic_Solosis_Redux),
    SPECIES_SPRITE(DUOSION_REDUX, gMonFrontPic_Duosion_Redux),
    SPECIES_SPRITE(REUNICLUS_REDUX, gMonFrontPic_Reuniclus_Redux),
    SPECIES_SPRITE(SKARMORY_REDUX, gMonFrontPic_Skarmory_Redux),
    SPECIES_SPRITE(MACHAMP_MEGA_REDUX, gMonFrontPic_Machamp_Mega_Redux),
    SPECIES_SPRITE(MACHAMP_REDUX, gMonFrontPic_Machamp_Redux),
    SPECIES_SPRITE(MACHOKE_REDUX, gMonFrontPic_Machoke_Redux),
    SPECIES_SPRITE(MACHOP_REDUX, gMonFrontPic_Machop_Redux),
    SPECIES_SPRITE(UXIE_REDUX, gMonFrontPic_Uxie_Redux),
    ...
    SPECIES_SPRITE(SIMISEAR_REDUX, gMonFrontPic_Simisear_Redux),
    SPECIES_SPRITE(PANSEAR_REDUX, gMonFrontPic_Pansear_Redux),
    SPECIES_SPRITE(SIMISAGE_REDUX, gMonFrontPic_Simisage_Redux),
    SPECIES_SPRITE(PANSAGE_REDUX, gMonFrontPic_Pansage_Redux),
    SPECIES_SPRITE(SIMIPOUR_REDUX, gMonFrontPic_Simipour_Redux),
    SPECIES_SPRITE(PANPOUR_REDUX, gMonFrontPic_Panpour_Redux),
    SPECIES_SPRITE(BEWEAR_REDUX, gMonFrontPic_Bewear_Redux),
    SPECIES_SPRITE(STUFFUL_REDUX, gMonFrontPic_Stufful_Redux),
    SPECIES_SPRITE(BEEDRILL_REDUX, gMonFrontPic_Beedrill_Redux),
    SPECIES_SPRITE(KAKUNA_REDUX, gMonFrontPic_Kakuna_Redux),
    SPECIES_SPRITE(WEEDLE_REDUX, gMonFrontPic_Weedle_Redux),
    SPECIES_SPRITE(ALAKAZAM_MEGA_REDUX, gMonFrontPic_Alakazam_Redux_Mega),
    SPECIES_SPRITE(ALAKAZAM_REDUX, gMonFrontPic_Alakazam_Redux),
    SPECIES_SPRITE(KADABRA_REDUX, gMonFrontPic_Kadabra_Redux),
    SPECIES_SPRITE(ABRA_REDUX, gMonFrontPic_Abra_Redux),
    SPECIES_SPRITE(AEGISLASH_BLADE_REDUX, gMonFrontPic_Aegislash_Blade_Redux),
    SPECIES_SPRITE(AEGISLASH_REDUX, gMonFrontPic_Aegislash_Redux),
    SPECIES_SPRITE(DOUBLADE_REDUX, gMonFrontPic_Doublade_Redux),
    SPECIES_SPRITE(HONEDGE_REDUX, gMonFrontPic_Honedge_Redux),
    SPECIES_SPRITE(RIBOMBEE_MEGA, gMonFrontPic_Ribombee_Mega),
    ...
    SPECIES_SPRITE(GREAT_TUSK, gMonFrontPic_Great_Tusk),
    SPECIES_SPRITE(SCREAM_TAIL, gMonFrontPic_Scream_Tail),
    SPECIES_SPRITE(BRUTE_BONNET, gMonFrontPic_Brute_Bonnet),
    SPECIES_SPRITE(FLUTTER_MANE, gMonFrontPic_Flutter_Mane),
    SPECIES_SPRITE(SLITHER_WING, gMonFrontPic_Slither_Wing),
    SPECIES_SPRITE(SANDY_SHOCKS, gMonFrontPic_Sandy_Shocks),
    SPECIES_SPRITE(IRON_TREADS, gMonFrontPic_Iron_Treads),
    SPECIES_SPRITE(IRON_BUNDLE, gMonFrontPic_Iron_Bundle),
    SPECIES_SPRITE(IRON_HANDS, gMonFrontPic_Iron_Hands),
    SPECIES_SPRITE(IRON_JUGULIS, gMonFrontPic_Iron_Jugulis),
    SPECIES_SPRITE(IRON_MOTH, gMonFrontPic_Iron_Moth),
    SPECIES_SPRITE(IRON_THORNS, gMonFrontPic_Iron_Thorns),
    ...
    SPECIES_SPRITE(WO_CHIEN, gMonFrontPic_Wo_Chien),
    SPECIES_SPRITE(CHIEN_PAO, gMonFrontPic_Chien_Pao),
    SPECIES_SPRITE(TING_LU, gMonFrontPic_Ting_Lu),
    SPECIES_SPRITE(CHI_YU, gMonFrontPic_Chi_Yu),
    SPECIES_SPRITE(ROARING_MOON, gMonFrontPic_Roaring_Moon),
    SPECIES_SPRITE(IRON_VALIANT, gMonFrontPic_Iron_Valiant),
    SPECIES_SPRITE(KORAIDON, gMonFrontPic_Koraidon),
    SPECIES_SPRITE(MIRAIDON, gMonFrontPic_Miraidon),
    SPECIES_SPRITE(WALKING_WAKE, gMonFrontPic_Walking_Wake),
    SPECIES_SPRITE(IRON_LEAVES, gMonFrontPic_Iron_Leaves),
    ...
    SPECIES_SPRITE(PHANTOWL, gMonFrontPic_Phantowl),
    SPECIES_SPRITE(DUELUMBER, gMonFrontPic_Duelumber),
    SPECIES_SPRITE(TYRANITAR_MEGA_REDUX_2, gMonFrontPic_Tyranitar_Mega_Redux_2),
    SPECIES_SPRITE(TYRANITAR_REDUX_2, gMonFrontPic_Tyranitar_Redux_2),
    SPECIES_SPRITE(PUPITAR_REDUX_2, gMonFrontPic_Pupitar_Redux_2),
    SPECIES_SPRITE(LARVITAR_REDUX_2, gMonFrontPic_Larvitar_Redux_2),
    SPECIES_SPRITE(SCIZOR_REDUX, gMonFrontPic_Scizor_Redux),
    SPECIES_SPRITE(SCIZOR_MEGA_REDUX, gMonFrontPic_Scizor_Mega_Redux),
    SPECIES_SPRITE(URSALUNA_MEGA, gMonFrontPic_Ursaluna_Mega),
    SPECIES_SPRITE(TYRANITAR_MEGA_REDUX, gMonFrontPic_Tyranitar_Mega_Redux),
    SPECIES_SPRITE(TYRANITAR_REDUX, gMonFrontPic_Tyranitar_Redux),
    SPECIES_SPRITE(PUPITAR_REDUX, gMonFrontPic_Pupitar_Redux),
    SPECIES_SPRITE(LARVITAR_REDUX, gMonFrontPic_Larvitar_Redux),
    SPECIES_SPRITE(CASTFORM_SANDY, gMonFrontPic_Castform_Sandy),
    SPECIES_SPRITE(KINGAMBIT_REDUX, gMonFrontPic_Kingambit_Redux),
    SPECIES_SPRITE(ENAMORUS_THERIAN, gMonFrontPic_Enamorus_Therian),
    SPECIES_SPRITE(PALKIA_ORIGIN, gMonFrontPic_Palkia_Origin_Forme),
    SPECIES_SPRITE(DIALGA_ORIGIN, gMonFrontPic_Dialga_Origin_Forme),
    SPECIES_SPRITE(OGERPON_HEARTHFLAME_MASK, gMonFrontPic_Ogerpon_Hearthflame_Mask),
    SPECIES_SPRITE(OGERPON_CORNERSTONE_MASK, gMonFrontPic_Ogerpon_Cornerstone_Mask),
    SPECIES_SPRITE(OGERPON_WELLSPRING_MASK, gMonFrontPic_Ogerpon_Wellspring_Mask),
    SPECIES_SPRITE(SQUAWKABILLY_WHITE_PLUMAGE, gMonFrontPic_Squawkabilly_White_Plumage),
    SPECIES_SPRITE(SQUAWKABILLY_YELLOW_PLUMAGE, gMonFrontPic_Squawkabilly_Yellow_Plumage),
    SPECIES_SPRITE(SQUAWKABILLY_BLUE_PLUMAGE, gMonFrontPic_Squawkabilly_Blue_Plumage),
    SPECIES_SPRITE(SQUAWKABILLY_GREEN_PLUMAGE, gMonFrontPic_Squawkabilly_Green_Plumage),
    SPECIES_SPRITE(TATSUGIRI_DROOPY, gMonFrontPic_Tatsugiri_Droopy),
    SPECIES_SPRITE(TATSUGIRI_STRETCHY, gMonFrontPic_Tatsugiri_Stretchy),
    SPECIES_SPRITE(TATSUGIRI_CURLY, gMonFrontPic_Tatsugiri_Curly),
    SPECIES_SPRITE(MAUSHOLD_FOUR, gMonFrontPic_Maushold_Four),
    SPECIES_SPRITE(DUDUNSPARCE_THREE_SEGMENT, gMonFrontPic_Dudunsparce_Three_Segment),
    SPECIES_SPRITE(PALAFIN_HERO, gMonFrontPic_Palafin_Hero),
    SPECIES_SPRITE(URSALUNA_MOONBLOOD, gMonFrontPic_Ursaluna_Moonblood),
    SPECIES_SPRITE(TAUROS_PALDEAN_COMBAT_BREED, gMonFrontPic_Tauros_Paldean_Combat_Breed),
    SPECIES_SPRITE(TAUROS_PALDEAN_BLAZE_BREED, gMonFrontPic_Tauros_Paldean_Blaze_Breed),
    SPECIES_SPRITE(TAUROS_PALDEAN_AQUA_BREED, gMonFrontPic_Tauros_Paldean_Aqua_Breed),
    SPECIES_SPRITE(DECIDUEYE_HISUIAN, gMonFrontPic_Decidueye_Hisuian),
    SPECIES_SPRITE(AVALUGG_HISUIAN, gMonFrontPic_Avalugg_Hisuian),
    SPECIES_SPRITE(GOODRA_HISUIAN, gMonFrontPic_Goodra_Hisuian),
    SPECIES_SPRITE(SLIGGOO_HISUIAN, gMonFrontPic_Sliggoo_Hisuian),
    SPECIES_SPRITE(BRAVIARY_HISUIAN, gMonFrontPic_Braviary_Hisuian),
    SPECIES_SPRITE(ZORUA_HISUIAN, gMonFrontPic_Zorua_Hisuian),
    SPECIES_SPRITE(LILLIGANT_HISUIAN, gMonFrontPic_Lilligant_Hisuian),
    SPECIES_SPRITE(SAMUROTT_HISUIAN, gMonFrontPic_Samurott_Hisuian),
    SPECIES_SPRITE(SNEASEL_HISUIAN, gMonFrontPic_Sneasel_Hisuian),
    SPECIES_SPRITE(TYPHLOSION_HISUIAN, gMonFrontPic_Typhlosion_Hisuian),
    SPECIES_SPRITE(ELECTRODE_HISUIAN, gMonFrontPic_Electrode_Hisuian),
    SPECIES_SPRITE(VOLTORB_HISUIAN, gMonFrontPic_Voltorb_Hisuian),
    SPECIES_SPRITE(ARCANINE_HISUIAN, gMonFrontPic_Arcanine_Hisuian),
    SPECIES_SPRITE(GROWLITHE_HISUIAN, gMonFrontPic_Growlithe_Hisuian),
    SPECIES_SPRITE(QWILFISH_HISUIAN, gMonFrontPic_Qwilfish_Hisuian),
    ...
    SPECIES_SPRITE(DEWGONG_MEGA,      gMonFrontPic_DewgongMega),
    SPECIES_SPRITE(HITMONCHAN_MEGA,   gMonFrontPic_HitmonchanMega),
    SPECIES_SPRITE(HITMONLEE_MEGA,    gMonFrontPic_HitmonleeMega),
    SPECIES_SPRITE(HITMONTOP_MEGA,    gMonFrontPic_HitmontopMega),
    SPECIES_SPRITE(CROBAT_MEGA,       gMonFrontPic_CrobatMega),
    SPECIES_SPRITE(SKARMORY_MEGA,     gMonFrontPic_SkarmoryMega),
    SPECIES_SPRITE(BRUXISH_MEGA,      gMonFrontPic_BruxishMega),
    ...
    SPECIES_SPRITE(RELICANTH_MEGA,    gMonFrontPic_RelicanthMega),
    SPECIES_SPRITE(QUAGSIRE_MEGA,     gMonFrontPic_QuagsireMega),
    SPECIES_SPRITE(JELLICENT_MEGA,    gMonFrontPic_JellicentMega),
    SPECIES_SPRITE(TOUCANNON_MEGA,    gMonFrontPic_ToucannonMega),
    SPECIES_SPRITE(DRAGONITE_MEGA,    gMonFrontPic_DragoniteMega),
    SPECIES_SPRITE(BRELOOM_MEGA,      gMonFrontPic_BreloomMega),
    SPECIES_SPRITE(SLAKING_MEGA,      gMonFrontPic_SlakingMega),
    SPECIES_SPRITE(FERALIGATR_MEGA_X, gMonFrontPic_FeraligatrMegaX),
    SPECIES_SPRITE(FERALIGATR_MEGA_Y, gMonFrontPic_FeraligatrMegaY),
    SPECIES_SPRITE(GRANBULL_MEGA,     gMonFrontPic_GranbullMega),
    SPECIES_SPRITE(GYARADOS_MEGA_Y,   gMonFrontPic_GyaradosMegaY),
    SPECIES_SPRITE(HAXORUS_MEGA,      gMonFrontPic_HaxorusMega),
    SPECIES_SPRITE(KINGDRA_MEGA_Y,    gMonFrontPic_KingdraMegaY),
    ...
    SPECIES_SPRITE(SANDSLASH_MEGA,    gMonFrontPic_SandslashMega),
    ...
    SPECIES_SPRITE(KROOKODILE_MEGA,   gMonFrontPic_KrookodileMega),
    SPECIES_SPRITE(MAGNEZONE_MEGA,    gMonFrontPic_MagnezoneMega),
    SPECIES_SPRITE(SHEDINJA_MEGA,     gMonFrontPic_ShedinjaMega),
    SPECIES_SPRITE(SWALOT_MEGA,       gMonFrontPic_SwalotMega),
    SPECIES_SPRITE(LANTURN_MEGA,      gMonFrontPic_LanturnMega),
    SPECIES_SPRITE(LAPRAS_MEGA_X,     gMonFrontPic_LaprasMegaX),
    SPECIES_SPRITE(CLAWITZER_REDUX, gMonFrontPic_ClawitzerRedux),
    SPECIES_SPRITE(DEWLEON,           gMonFrontPic_Dewleon),
