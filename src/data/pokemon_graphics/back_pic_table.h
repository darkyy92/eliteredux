const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(TYRANITAR_MEGA_REDUX_2, gMonBackPic_Tyranitar_Mega_Redux_2),
    SPECIES_SPRITE(TYRANITAR_REDUX_2, gMonBackPic_Tyranitar_Redux_2),
    SPECIES_SPRITE(PUPITAR_REDUX_2, gMonBackPic_Pupitar_Redux_2),
    SPECIES_SPRITE(LARVITAR_REDUX_2, gMonBackPic_Larvitar_Redux_2),
    ...
    SPECIES_SPRITE(DIALGA_ORIGIN, gMonBackPic_Palkia_Origin_Forme),
    SPECIES_SPRITE(PALKIA_ORIGIN, gMonBackPic_Dialga_Origin_Forme),
