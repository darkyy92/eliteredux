const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(GIRATINA_ORIGIN_FORME, gMonBackPic_Giratina_Origin_Forme),
    SPECIES_SPRITE(PALKIA_ORIGIN_FORME, gMonBackPic_Palkia_Origin_Forme),
    SPECIES_SPRITE(DIALGA_ORIGIN_FORME, gMonBackPic_Dialga_Origin_Forme),
    SPECIES_SPRITE(ROTOM_WASH_MODE, gMonBackPic_Rotom_Wash_Mode),
    SPECIES_SPRITE(ROTOM_FAN_MODE, gMonBackPic_Rotom_Fan_Mode),
    SPECIES_SPRITE(ROTOM_HEAT_MODE, gMonBackPic_Rotom_Heat_Mode),
    SPECIES_SPRITE(ROTOM_FROST_MODE, gMonBackPic_Rotom_Frost_Mode),
    SPECIES_SPRITE(ROTOM_MOW_MODE, gMonBackPic_Rotom_Mow_Mode),
    ...
    SPECIES_SPRITE(URSALUNA_MOONBLOOD, gMonBackPic_Ursaluna_Moonblood),
