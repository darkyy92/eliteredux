const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(DODRIO_REDUX, gMonPalette_Dodrio_Redux),
    SPECIES_PAL(DODUO_REDUX, gMonPalette_Doduo_Redux),
    SPECIES_PAL(SCRAFTY_MEGA, gMonPalette_Scrafty_Mega),
    SPECIES_PAL(FROSLASS_MEGA, gMonPalette_Froslass_Mega),
    SPECIES_PAL(HOUNDOOM_MEGA_REDUX, gMonPalette_Houndoom_Mega_Redux),
    SPECIES_PAL(HOUNDOOM_REDUX, gMonPalette_Houndoom_Redux),
    SPECIES_PAL(HOUNDOUR_REDUX, gMonPalette_Houndour_Redux),
    SPECIES_PAL(SABLEYE_MEGA_REDUX, gMonPalette_Sableye_Mega_Redux),
    SPECIES_PAL(SABLEYE_REDUX, gMonPalette_Sableye_Redux),
    SPECIES_PAL(MAWILE_MEGA_REDUX, gMonPalette_Mawile_Mega_Redux),
    SPECIES_PAL(MAWILE_REDUX, gMonPalette_Mawile_Redux),
    SPECIES_PAL(BISHARP_REDUX, gMonPalette_Bisharp_Redux),
    SPECIES_PAL(PAWNIARD_REDUX, gMonPalette_Pawniard_Redux),
    SPECIES_PAL(HYDREIGON_REDUX, gMonPalette_Hydreigon_Redux),
    SPECIES_PAL(ZWEILOUS_REDUX, gMonPalette_Zweilous_Redux),
    SPECIES_PAL(DEINO_REDUX, gMonPalette_Deino_Redux),
    SPECIES_PAL(GARCHOMP_MEGA_REDUX, gMonPalette_Garchomp_Mega_Redux),
    SPECIES_PAL(GARCHOMP_REDUX, gMonPalette_Garchomp_Redux),
    SPECIES_PAL(GABITE_REDUX, gMonPalette_Gabite_Redux),
    SPECIES_PAL(GIBLE_REDUX, gMonPalette_Gible_Redux),
    SPECIES_PAL(EXPLOUD_REDUX, gMonPalette_Exploud_Redux),
    SPECIES_PAL(LOUDRED_REDUX, gMonPalette_Loudred_Redux),
    SPECIES_PAL(WHISMUR_REDUX, gMonPalette_Whismur_Redux),
    SPECIES_PAL(ARCANINE_MEGA_REDUX, gMonPalette_Arcanine_Mega_Redux),
    SPECIES_PAL(ARCANINE_REDUX, gMonPalette_Arcanine_Redux),
    SPECIES_PAL(GROWLITHE_REDUX, gMonPalette_Growlithe_Redux),
    SPECIES_PAL(SKARMORY_MEGA_REDUX, gMonPalette_Skarmory_Mega_Redux),
    SPECIES_PAL(BEEDRILL_MEGA_REDUX, gMonPalette_Beedrill_Mega_Redux),
    SPECIES_PAL(SOLOSIS_REDUX, gMonPalette_Solosis_Redux),
    SPECIES_PAL(DUOSION_REDUX, gMonPalette_Duosion_Redux),
    SPECIES_PAL(REUNICLUS_REDUX, gMonPalette_Reuniclus_Redux),
    SPECIES_PAL(SKARMORY_REDUX, gMonPalette_Skarmory_Redux),
    SPECIES_PAL(MACHAMP_MEGA_REDUX, gMonPalette_Machamp_Mega_Redux),
    SPECIES_PAL(MACHAMP_REDUX, gMonPalette_Machamp_Redux),
    SPECIES_PAL(MACHOKE_REDUX, gMonPalette_Machoke_Redux),
    SPECIES_PAL(MACHOP_REDUX, gMonPalette_Machop_Redux),
    SPECIES_PAL(UXIE_REDUX, gMonPalette_Uxie_Redux),
    ...
    SPECIES_PAL(SIMISEAR_REDUX, gMonPalette_Simisear_Redux),
    SPECIES_PAL(PANSEAR_REDUX, gMonPalette_Pansear_Redux),
    SPECIES_PAL(SIMISAGE_REDUX, gMonPalette_Simisage_Redux),
    SPECIES_PAL(PANSAGE_REDUX, gMonPalette_Pansage_Redux),
    SPECIES_PAL(SIMIPOUR_REDUX, gMonPalette_Simipour_Redux),
    SPECIES_PAL(PANPOUR_REDUX, gMonPalette_Panpour_Redux),
    SPECIES_PAL(BEWEAR_REDUX, gMonPalette_Bewear_Redux),
    SPECIES_PAL(STUFFUL_REDUX, gMonPalette_Stufful_Redux),
    SPECIES_PAL(BEEDRILL_REDUX, gMonPalette_Beedrill_Redux),
    SPECIES_PAL(KAKUNA_REDUX, gMonPalette_Kakuna_Redux),
    SPECIES_PAL(WEEDLE_REDUX, gMonPalette_Weedle_Redux),
    SPECIES_PAL(ALAKAZAM_MEGA_REDUX, gMonPalette_Alakazam_Redux_Mega),
    SPECIES_PAL(ALAKAZAM_REDUX, gMonPalette_Alakazam_Redux),
    SPECIES_PAL(KADABRA_REDUX, gMonPalette_Kadabra_Redux),
    SPECIES_PAL(ABRA_REDUX, gMonPalette_Abra_Redux),
    SPECIES_PAL(AEGISLASH_BLADE_REDUX, gMonPalette_Aegislash_Blade_Redux),
    SPECIES_PAL(AEGISLASH_REDUX, gMonPalette_Aegislash_Redux),
    SPECIES_PAL(DOUBLADE_REDUX, gMonPalette_Doublade_Redux),
    SPECIES_PAL(HONEDGE_REDUX, gMonPalette_Honedge_Redux),
    SPECIES_PAL(RIBOMBEE_MEGA, gMonPalette_Ribombee_Mega),
    ...
    SPECIES_PAL(PHANTOWL, gMonPalette_Phantowl),
    SPECIES_PAL(DUELUMBER, gMonPalette_Duelumber),
    SPECIES_PAL(TYRANITAR_MEGA_REDUX_2, gMonPalette_Tyranitar_Mega_Redux_2),
    SPECIES_PAL(TYRANITAR_REDUX_2, gMonPalette_Tyranitar_Redux_2),
    SPECIES_PAL(PUPITAR_REDUX_2, gMonPalette_Pupitar_Redux_2),
    SPECIES_PAL(LARVITAR_REDUX_2, gMonPalette_Larvitar_Redux_2),
    ...
    SPECIES_PAL(PUPITAR_REDUX, gMonPalette_Pupitar_Redux),
    SPECIES_PAL(LARVITAR_REDUX, gMonPalette_Larvitar_Redux),
    SPECIES_PAL(CASTFORM_SANDY, gMonPalette_Castform_Sandy),
    SPECIES_PAL(KINGAMBIT_REDUX, gMonPalette_Kingambit_Redux),
    SPECIES_PAL(ENAMORUS_THERIAN, gMonPalette_Enamorus_Therian),
    SPECIES_PAL(PALKIA_ORIGIN, gMonPalette_Palkia_Origin_Forme),
    SPECIES_PAL(DIALGA_ORIGIN, gMonPalette_Dialga_Origin_Forme),
    SPECIES_PAL(OGERPON_HEARTHFLAME_MASK, gMonPalette_Ogerpon_Hearthflame_Mask),
    SPECIES_PAL(OGERPON_CORNERSTONE_MASK, gMonPalette_Ogerpon_Cornerstone_Mask),
    SPECIES_PAL(OGERPON_WELLSPRING_MASK, gMonPalette_Ogerpon_Wellspring_Mask),
    SPECIES_PAL(SQUAWKABILLY_WHITE_PLUMAGE, gMonPalette_Squawkabilly_White_Plumage),
    SPECIES_PAL(SQUAWKABILLY_YELLOW_PLUMAGE, gMonPalette_Squawkabilly_Yellow_Plumage),
    SPECIES_PAL(SQUAWKABILLY_BLUE_PLUMAGE, gMonPalette_Squawkabilly_Blue_Plumage),
    SPECIES_PAL(SQUAWKABILLY_GREEN_PLUMAGE, gMonPalette_Squawkabilly_Green_Plumage),
    ...
    SPECIES_PAL(DUDUNSPARCE_THREE_SEGMENT, gMonPalette_Dudunsparce_Three_Segment),
    SPECIES_PAL(PALAFIN_HERO, gMonPalette_Palafin_Hero),
    SPECIES_PAL(URSALUNA_MOONBLOOD, gMonPalette_Ursaluna_Moonblood),
    ...
    SPECIES_PAL(ARCANINE_HISUIAN, gMonPalette_Arcanine_Hisuian),
    ...
    SPECIES_PAL(DEWGONG_MEGA,      gMonPalette_DewgongMega),
    SPECIES_PAL(HITMONCHAN_MEGA,   gMonPalette_HitmonchanMega),
    SPECIES_PAL(HITMONLEE_MEGA,    gMonPalette_HitmonleeMega),
    SPECIES_PAL(HITMONTOP_MEGA,    gMonPalette_HitmontopMega),
    SPECIES_PAL(CROBAT_MEGA,       gMonPalette_CrobatMega),
    SPECIES_PAL(SKARMORY_MEGA,     gMonPalette_SkarmoryMega),
    SPECIES_PAL(BRUXISH_MEGA,      gMonPalette_BruxishMega),
    ...
    SPECIES_PAL(RELICANTH_MEGA,    gMonPalette_RelicanthMega),
    SPECIES_PAL(QUAGSIRE_MEGA,     gMonPalette_QuagsireMega),
    SPECIES_PAL(JELLICENT_MEGA,    gMonPalette_JellicentMega),
    SPECIES_PAL(TOUCANNON_MEGA,    gMonPalette_ToucannonMega),
    SPECIES_PAL(DRAGONITE_MEGA,    gMonPalette_DragoniteMega),
    SPECIES_PAL(BRELOOM_MEGA,      gMonPalette_BreloomMega),
    SPECIES_PAL(SLAKING_MEGA,      gMonPalette_SlakingMega),
    SPECIES_PAL(FERALIGATR_MEGA_X, gMonPalette_FeraligatrMegaX),
    SPECIES_PAL(FERALIGATR_MEGA_Y, gMonPalette_FeraligatrMegaY),
    SPECIES_PAL(GRANBULL_MEGA,     gMonPalette_GranbullMega),
    SPECIES_PAL(GYARADOS_MEGA_Y,   gMonPalette_GyaradosMegaY),
    SPECIES_PAL(HAXORUS_MEGA,      gMonPalette_HaxorusMega),
    SPECIES_PAL(KINGDRA_MEGA_Y,    gMonPalette_KingdraMegaY),
    ...
    SPECIES_PAL(SANDSLASH_MEGA,    gMonPalette_SandslashMega),
    ...
    SPECIES_PAL(KROOKODILE_MEGA,   gMonPalette_KrookodileMega),
    SPECIES_PAL(MAGNEZONE_MEGA,    gMonPalette_MagnezoneMega),
    SPECIES_PAL(SHEDINJA_MEGA,     gMonPalette_ShedinjaMega),
