const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(ROTOM_FAN_MODE, gMonPalette_Rotom_Fan_Mode),
    SPECIES_PAL(ROTOM_HEAT_MODE, gMonPalette_Rotom_Heat_Mode),
    SPECIES_PAL(ROTOM_FROST_MODE, gMonPalette_Rotom_Frost_Mode),
    SPECIES_PAL(ROTOM_MOW_MODE, gMonPalette_Rotom_Mow_Mode),
