const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(TYRANITAR_MEGA_REDUX_2, gMonShinyPalette_Tyranitar_Mega_Redux_2),
    SPECIES_SHINY_PAL(TYRANITAR_REDUX_2, gMonShinyPalette_Tyranitar_Redux_2),
    SPECIES_SHINY_PAL(PUPITAR_REDUX_2, gMonShinyPalette_Pupitar_Redux_2),
    SPECIES_SHINY_PAL(LARVITAR_REDUX_2, gMonShinyPalette_Larvitar_Redux_2),
    SPECIES_SHINY_PAL(SCIZOR_REDUX, gMonShinyPalette_Scizor_Redux),
    SPECIES_SHINY_PAL(SCIZOR_MEGA_REDUX, gMonShinyPalette_Scizor_Mega_Redux),
