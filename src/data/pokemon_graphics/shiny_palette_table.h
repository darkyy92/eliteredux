const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(GIRATINA_ORIGIN_FORME, gMonShinyPalette_Giratina_Origin_Forme),
    SPECIES_SHINY_PAL(PALKIA_ORIGIN_FORME, gMonShinyPalette_Palkia_Origin_Forme),
    SPECIES_SHINY_PAL(DIALGA_ORIGIN_FORME, gMonShinyPalette_Dialga_Origin_Forme),
    SPECIES_SHINY_PAL(ROTOM_WASH_MODE, gMonShinyPalette_Rotom_Wash_Mode),
    SPECIES_SHINY_PAL(ROTOM_FAN_MODE, gMonShinyPalette_Rotom_Fan_Mode),
    SPECIES_SHINY_PAL(ROTOM_HEAT_MODE, gMonShinyPalette_Rotom_Heat_Mode),
    SPECIES_SHINY_PAL(ROTOM_FROST_MODE, gMonShinyPalette_Rotom_Frost_Mode),
    SPECIES_SHINY_PAL(ROTOM_MOW_MODE, gMonShinyPalette_Rotom_Mow_Mode),
    ...
    SPECIES_SHINY_PAL(URSALUNA_MOONBLOOD, gMonShinyPalette_Ursaluna_Moonblood),
