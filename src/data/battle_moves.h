const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_DOUBLE_KICK] =
    {
        ...
        .secondaryEffectChance = 0,
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_STRIKER_BOOST | FLAG_TWO_STRIKES,
        .split = SPLIT_PHYSICAL,
    },
    [MOVE_MEGA_KICK] =
    {
    ...
    [MOVE_HORN_DRILL] =
    {
        ...
        .secondaryEffectChance = 20,
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_HIGH_CRIT | FLAG_SHEER_FORCE_BOOST | FLAG_STAT_STAGES_IGNORED | FLAG_TARGET_ABILITY_IGNORED,
        .flags2 = FLAG_HORN_BASED,
        .split = SPLIT_PHYSICAL,
    },
    [MOVE_TACKLE] =
    ...
    [MOVE_SOLAR_BEAM] =
    {
        ...
        .secondaryEffectChance = 0,
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_MEGA_LAUNCHER_BOOST | FLAG_WEATHER_BASED,
        .split = SPLIT_SPECIAL,
    },
    [MOVE_POISON_POWDER] =
    {
    ...
    [MOVE_OCTAZOOKA] =
    {
        ...
        .secondaryEffectChance = 100,
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_SHEER_FORCE_BOOST | FLAG_MEGA_LAUNCHER_BOOST | FLAG_BALLISTIC,
        .split = SPLIT_SPECIAL,
    },
    [MOVE_SPIKES] =
    {
    ...
    [MOVE_MUD_SHOT] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 1,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_SHEER_FORCE_BOOST | FLAG_MEGA_LAUNCHER_BOOST | FLAG_BALLISTIC | FLAG_DMG_2X_IN_AIR,
        .split = SPLIT_SPECIAL,
    },
    [MOVE_POISON_TAIL] =
    {
    ...
    [MOVE_FLARE_BLITZ] =
    {
        ...
        .secondaryEffectChance = 10,
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_RECKLESS_BOOST | FLAG_SHEER_FORCE_BOOST | FLAG_THAW_USER,
        .split = SPLIT_PHYSICAL,
    ...
    [MOVE_DUAL_CHOP] =
    {
        ...
        .secondaryEffectChance = 0,
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_HIGH_CRIT | FLAG_TWO_STRIKES | FLAG_KEEN_EDGE_BOOST,
        .split = SPLIT_PHYSICAL,
    },
    [MOVE_HEART_STAMP] =
    {
    ...
    [MOVE_RAZOR_SHELL] =
    {
        ...
        .secondaryEffectChance = 50,
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_HIGH_CRIT | FLAG_SHEER_FORCE_BOOST | FLAG_KEEN_EDGE_BOOST,
        .split = SPLIT_PHYSICAL,
    },
    [MOVE_HEAT_CRASH] =
    {
    ...
    [MOVE_FIERY_DANCE] =
    {
        ...
        .secondaryEffectChance = 50,
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_SHEER_FORCE_BOOST | FLAG_DANCE,
        .split = SPLIT_SPECIAL,
    },
    [MOVE_FREEZE_SHOCK] =
    {
    ...
    [MOVE_BEAK_BLAST] =
    {
        ...
        .secondaryEffectChance = 30,
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_SHEER_FORCE_BOOST | FLAG_BALLISTIC,
        .split = SPLIT_PHYSICAL,
    },
    ...
    [MOVE_SUNSTEEL_STRIKE] =
    {
        ...
        .secondaryEffectChance = 0,
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_MEGA_LAUNCHER_BOOST | FLAG_TARGET_ABILITY_IGNORED,
        .split = SPLIT_PHYSICAL,
    },
    [MOVE_MOONGEIST_BEAM] =
    {
    ...
    [MOVE_PYRO_BALL] =
    {
        ...
        .secondaryEffectChance = 10,
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_SHEER_FORCE_BOOST | FLAG_STRIKER_BOOST | FLAG_BALLISTIC | FLAG_THAW_USER,
        .split = SPLIT_PHYSICAL,
    },
    [MOVE_BEHEMOTH_BLADE] =
    {
    ...
    [MOVE_DEATHROLL] =
    {
        ...
        .secondaryEffectChance = 20,
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_SHEER_FORCE_BOOST | FLAG_STRONG_JAW_BOOST | FLAG_STAT_STAGES_IGNORED,
        .split = SPLIT_PHYSICAL,
    },
    [MOVE_EXCALIBUR] =
    {
        ...
        .secondaryEffectChance = 20,
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_HIGH_CRIT | FLAG_SHEER_FORCE_BOOST | FLAG_KEEN_EDGE_BOOST,
        .split = SPLIT_PHYSICAL,
    },
    [MOVE_AQUA_FANG] =
    {
    ...
    [MOVE_SUPERSONIC_SHOT] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED,
        .flags2 = FLAG_ALWAYS_CRIT | FLAG_ARROW_BASED,
        .split = SPLIT_PHYSICAL,
    },
    [MOVE_ZEPHYR_RUSH] =
    {
    ...
    [MOVE_CUTSIE_SLAP] =
    {
        ...
        .secondaryEffectChance = 10,
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_IRON_FIST_BOOST | FLAG_SHEER_FORCE_BOOST,
        .split = SPLIT_SPECIAL,
        .argument = MOVE_EFFECT_PARALYSIS,
    },
    [MOVE_FAIRY_SPHERES] =
    ...
    [MOVE_TWIN_BEAM] =
    {
        ...
        .secondaryEffectChance = 0,
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_MEGA_LAUNCHER_BOOST | FLAG_TWO_STRIKES,
        .split = SPLIT_SPECIAL,
    },
    [MOVE_REQUIEM] =
    {
    ...
    [MOVE_SPIN_OUT] =
    {
        ...
        .flags = FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED,
        .split = SPLIT_PHYSICAL,
        .argument = MOVE_EFFECT_SPD_MINUS_2 | MOVE_EFFECT_AFFECTS_USER | MOVE_EFFECT_CERTAIN,
    },
    [MOVE_SALT_CURE] =
    {
        .effect = EFFECT_ARGUMENT_HIT,
    ...
    [MOVE_MAKE_IT_RAIN] =
    {
        ...
        .flags = FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED,
        .split = SPLIT_SPECIAL,
        .argument = MOVE_EFFECT_SP_ATK_MINUS_1 | MOVE_EFFECT_AFFECTS_USER | MOVE_EFFECT_CERTAIN,
    },
    [MOVE_PSYBLADE] =
    {
        .effect = EFFECT_MISC_HIT,
    ...
    [MOVE_MIGHTY_CLEAVE] =
    {
        ...
        .secondaryEffectChance = 0,
        .target = MOVE_TARGET_SELECTED,
        .flags = FLAG_MAKES_CONTACT | FLAG_MIRROR_MOVE_AFFECTED | FLAG_KINGS_ROCK_AFFECTED | FLAG_KEEN_EDGE_BOOST,
        .split = SPLIT_PHYSICAL,
    },
    [MOVE_TEMPER_FLARE] =
    {
...
const struct IntimidateCloneData gIntimidateCloneData[NUM_INTIMIDATE_CLONES] = {
    ...
    [I_CLONE_MALICIOUS] = {
        ...
        .numStatsLowered = 2,
        .statsLowered = { 
            STAT_HIGHEST_ATTACKING | STAT_USE_STAT_BOOSTS_IN_CALC,
            STAT_HIGHEST_DEFENDING | STAT_USE_STAT_BOOSTS_IN_CALC,
            0
        },
        .targetBoth = TRUE,
    },
