const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_SUPERSONIC_SHOT] = _("S.Sonic Shot"),
    [MOVE_ZEPHYR_RUSH] = _("Zephyr Rush"),
    [MOVE_SHOCKING_JAB] = _("Shock Jab"),
    ...
    [MOVE_FLUTTERING_LEAF] = _("FLUTTERING L"),
    [MOVE_HEADLONG_RUSH] = _("HEADLONG RUS"),
    [MOVE_REVIVAL_BLESSING] = _("REVIVAL BLES"),
    [MOVE_WHIRLING_STRIKES] = _("WHIRLING STR"),
    ...
    [MOVE_FIRE_HYDRO_STEAM] = _("FIRE HYDRO S"),
    [MOVE_TRIPLE_ARROWS] = _("TRIPLE ARROW"),
    [MOVE_DOUBLE_LARIAT] = _("DOUBLE LARIA"),
    [MOVE_SPECIAL_AQUA_JET] = _("SPECIAL AQUA"),
    [MOVE_LEECH_BLADE] = _("LEECH BLADE"),
    [MOVE_YGGDRASIL_FORCE] = _("YGGDRASIL FO"),
    [MOVE_DRAIN_BRAIN] = _("DRAIN BRAIN"),
    [MOVE_PSYCHOKINETIC_SLAM] = _("PSYCHOKINETI"),
    ...
    [MOVE_KARMA] = _("KARMA"),
    [MOVE_CHILLING_WATER] = _("CHILLING WAT"),
    [MOVE_GHASTLY_ECHO] = _("GHASTLY ECHO"),
    [MOVE_CHILLY_RECEPTION] = _("CHILLY RECEP"),
    ...
    [MOVE_GIGATON_HAMMER] = _("GIGATON HAM"),
    [MOVE_TRIPLE_DIVE] = _("TRIPLE DIVE"),
    [MOVE_JET_PUNCH] = _("JET PUNCH"),
    [MOVE_RAGE_FIST] = _("Rage Fist"),
    [MOVE_WICKED_TORQUE] = _("WICKED TORQ"),
    [MOVE_BLAZING_TORQUE] = _("BLAZING TOR"),
    ...
    [MOVE_LAST_RESPECTS] = _("Last Respect"),
    [MOVE_LUMINA_CRASH] = _("Lumina Crash"),
    [MOVE_ORDER_UP] = _("Order Up"),
    [MOVE_SPICY_EXTRACT] = _("Spic Extract"),
    ...
    [MOVE_ELECTRO_DRIFT] = _("Eletro Drift"),
    ...
    [MOVE_FLICKLE_BEAM] = _("Flickle Beam"),
    [MOVE_BURNING_BULWARK] = _("Burn Bulwark"),
    [MOVE_THUNDERCLAP] = _("Thunderclap"),
    [MOVE_TACHYON_CUTTER] = _("Tachyon Cut."),
...
const u8 gMoveNamesLong[MOVES_COUNT][LONG_MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_BERRY_SMASH] = _("BERRY SMASH"),
    [MOVE_HYDRO_STEAM] = _("Hydro Steam"),
    [MOVE_FIRE_HYDRO_STEAM] = _("FIRE HYDRO STEAM"),
    [MOVE_TRIPLE_ARROWS] = _("TRIPLE ARROWS"),
    [MOVE_DOUBLE_LARIAT] = _("DOUBLE LARIAT"),
    [MOVE_SPECIAL_AQUA_JET] = _("SPECIAL AQUA JET"),
    [MOVE_LEECH_BLADE] = _("LEECH BLADE"),
