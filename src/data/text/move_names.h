const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_LIGHTING_STRIKE] = _("Light Strike"),
    ...
    [MOVE_FIRE_HYDRO_STEAM] = _("SuperhotFlme"),
    [MOVE_TRIPLE_ARROWS] = _("Triple Arrow"),
    [MOVE_DOUBLE_LARIAT] = _("DoubleLariat"),
    [MOVE_SPECIAL_AQUA_JET] = _("Quick Stream"),
...
const u8 gMoveNamesLong[MOVES_COUNT][LONG_MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_LIGHTING_STRIKE] = _("Lighting Strike"),
    [MOVE_VOLT_BOLT] = _("Volt Bolt"),
    ...
    [MOVE_BERRY_SMASH] = _("Berry Smash"),
    [MOVE_HYDRO_STEAM] = _("Hydro Steam"),
    [MOVE_FIRE_HYDRO_STEAM] = _("Superhot Flame"),
