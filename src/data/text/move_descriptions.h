...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_CUPID_SHOT        - 1] = sFROST_BRANDDescription, //ToChange
    [MOVE_CLAY_DART         - 1] = sFROST_BRANDDescription, //ToChange
    ...
    [MOVE_FLAME_TONGUE      - 1] = sFROST_BRANDDescription, //ToChange
    [MOVE_BLAZING_ARROW     - 1] = sFROST_BRANDDescription, //ToChange
    ...
    [MOVE_TORRENT_FIST - 1] = sCheapShotDescription,
    [MOVE_STAR_CRASH - 1] = sCheapShotDescription,
    [MOVE_STONE_AXE - 1] = sCheapShotDescription,
    [MOVE_ENERGY_WAVE - 1] = sCheapShotDescription,
    [MOVE_GRASS_FLIP_TURN - 1] = sCheapShotDescription,
    [MOVE_HEADLONG_RUSH - 1] = sCheapShotDescription,
    [MOVE_REVIVAL_BLESSING - 1] = sCheapShotDescription,
    [MOVE_WHIRLING_STRIKES - 1] = sCheapShotDescription,
    [MOVE_MIND_BREAK - 1] = sCheapShotDescription,
    [MOVE_WYRM_WIND - 1] = sCheapShotDescription,
    [MOVE_SHED_TAIL - 1] = sCheapShotDescription,
    [MOVE_BERRY_SMASH - 1] = sCheapShotDescription,
    [MOVE_HYDRO_STEAM - 1] = sCheapShotDescription,
    [MOVE_FIRE_HYDRO_STEAM - 1] = sCheapShotDescription,
    [MOVE_TRIPLE_ARROWS - 1] = sCheapShotDescription,
    [MOVE_DOUBLE_LARIAT - 1] = sCheapShotDescription,
    [MOVE_SPECIAL_AQUA_JET - 1] = sCheapShotDescription,
    [MOVE_LEECH_BLADE - 1] = sCheapShotDescription,
    [MOVE_YGGDRASIL_FORCE - 1] = sCheapShotDescription,
    [MOVE_DRAIN_BRAIN - 1] = sCheapShotDescription,
    [MOVE_PSYCHIC_DOUBLE_EDGE - 1] = sCheapShotDescription,
    [MOVE_ESPER_WING - 1] = sCheapShotDescription,
    [MOVE_SPECIAL_MORTAL_SPIN - 1] = sCheapShotDescription,
    [MOVE_GEM_MISSILE - 1] = sCheapShotDescription,
    [MOVE_RIDER_KICK - 1] = sCheapShotDescription,
    [MOVE_AQUA_CUTTER - 1] = sCheapShotDescription,
    [MOVE_INVERSE_ROOM - 1] = sCheapShotDescription,
    [MOVE_FIRE_BONE_RUSH - 1] = sCheapShotDescription,
};
...
const u8 *const gMoveFourLineDescriptionPointers[MOVES_COUNT - 1] = {
    ...
    [MOVE_CUPID_SHOT        - 1] = sMoveFourLineDescription_FrostBrand, //ToChange
    [MOVE_CLAY_DART         - 1] = sMoveFourLineDescription_FrostBrand, //ToChange
    ...
    [MOVE_FLAME_TONGUE      - 1] = sMoveFourLineDescription_FrostBrand, //ToChange
    [MOVE_BLAZING_ARROW     - 1] = sMoveFourLineDescription_FrostBrand, //ToChange
    ...
    [MOVE_TORRENT_FIST - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_STAR_CRASH - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_STONE_AXE - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_ENERGY_WAVE - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_GRASS_FLIP_TURN - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_HEADLONG_RUSH - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_REVIVAL_BLESSING - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_WHIRLING_STRIKES - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_MIND_BREAK - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_WYRM_WIND - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_SHED_TAIL - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_BERRY_SMASH - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_HYDRO_STEAM - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_FIRE_HYDRO_STEAM - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_TRIPLE_ARROWS - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_DOUBLE_LARIAT - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_SPECIAL_AQUA_JET - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_LEECH_BLADE - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_YGGDRASIL_FORCE - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_DRAIN_BRAIN - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_PSYCHIC_DOUBLE_EDGE - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_ESPER_WING - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_SPECIAL_MORTAL_SPIN - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_GEM_MISSILE - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_RIDER_KICK - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_AQUA_CUTTER - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_INVERSE_ROOM - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_FIRE_BONE_RUSH - 1] = sMoveFourLineDescription_CheapShot,
};