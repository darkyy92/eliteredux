...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_PSYCHOKINETIC_SLAM - 1] = sCheapShotDescription,
    [MOVE_ESPER_WING - 1] = sCheapShotDescription,
    [MOVE_MORTAL_SPIN - 1] = sCheapShotDescription,
...
const u8 *const gMoveFourLineDescriptionPointers[MOVES_COUNT - 1] = {
    ...
    [MOVE_PSYCHOKINETIC_SLAM - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_ESPER_WING - 1] = sMoveFourLineDescription_CheapShot,
    [MOVE_MORTAL_SPIN - 1] = sMoveFourLineDescription_CheapShot,
