...
static const u8 sLimberDescription[] = _("Prevents paralysis. Takes 50%\nless recoil damage.");
...
static const u8 sCompoundEyesDescription[] = _("1.3x accuracy boost.");
...
static const u8 sPlusDescription[] = _("Doubles damage with Minus.");
static const u8 sMinusDescription[] = _("Doubles damage with Plus.");
...
static const u8 sUnburdenDescription[] = _("Using a hold item\ndoubles Speed."); // new
...
static const u8 sNormalizeDescription[] = _("Moves become Normal-type, get\na 10% boost, and ignore resists.");
...
static const u8 sFilterDescription[] = _("Weakens “supereffective” by 35%.");
...
static const u8 sFriskDescription[] = _("Checks a foe's item and\ndisables it for two turns.");
...
static const u8 sWeakArmorDescription[] = _("On contact: -1 Defense\nand +2 Speed.");
static const u8 sHeavyMetalDescription[] = _("Doubles weight.");
static const u8 sLightMetalDescription[] = _("Raises speed by 30%\nHalves weight.");
...
static const u8 sTriageDescription[] = _("Healing moves have +1 priority.");
...
static const u8 sSandSongDescription[] = _("Normal sound moves become Ground\nand get a 20% boost.");
...
static const u8 sTectonizeDescription[] = _("Normal moves become Ground\nand get a 10% boost.");
...
static const u8 sRawWoodDescription[] = _("Halves incoming Grass-type damage.\nBoosts Grass-type moves by 20%.");
...
static const u8 sSolarFlareDescription[] = _("Chloroplast + Immolate.\nFire moves gain STAB.");
static const u8 sPowerCoreDescription[] = _("The Pokémon uses +20% of its\nDefense or SpDef during moves.");
...
static const u8 sDisciplineDescription[] = _("Rampage moves no longer trap you.\nCan't be confused or intimidated.");
...
static const u8 sLethargyDescription[] = _("Damage drops 20% each turn to 20%.\nResets on switch-in.");
...
static const u8 sRetributionBlowDescription[] = _("Uses Hyper Beam if any foe\nuses an stat boosting move.");
static const u8 sFearmongerDescription[] = _("Intimidate + Scare; 10%\npara chance on contact moves.");
static const u8 sKingsWrathDescription[] = _("Lowering any stats on its\nside raises Atk and Def.");
static const u8 sQueensMourningDescription[] = _("Lowering any stats on its\nside raises SpAtk and SpDef.");
static const u8 sToxicSpillDescription[] = _("Non-Poison-types get 1/8 dmg\nevery turn when on field.");
...
static const u8 sAtomicBurstDescription[] = _("When hit super-effectively,\ntriggers 50 BP Hyper Beam.");
...
static const u8 sGiftedMindDescription[] = _("Nulls Psychic weakness;\nstatus moves always hit.");
static const u8 sHydroCircuitDescription[] = _("Electric moves +50%;\nWater moves siphon 25% damage.");
static const u8 sEquinoxDescription[] = _("Boosts Atk or SpAtk to\nmatch the higher value.");
...
static const u8 sDuneTerrorDescription[] = _("Sand reduces damage by 35%.\nBoosts Ground moves by 20%.");
static const u8 sInfernalRageDescription[] = _("Fire-type moves are boosted\nby 35% with 5% recoil.");
static const u8 sDualWieldDescription[] = _("Mega Launcher and Keen Edge\nmoves hit twice for 75% damage.");
static const u8 sElementalChargeDescription[] = _("20% chance to BRN/FRZ/PARA\nwith respective types.");
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
    {
        ...
        [ABILITY_TECTONIZE] = sTectonizeDescription,
        ...
        [ABILITY_NOSFERATU] = sNosferatuDescription,
        [ABILITY_SPECTRAL_SHROUD] = sSpectralShroudDescription,
        [ABILITY_DISCIPLINE] = sDisciplineDescription,
        [ABILITY_THUNDERCALL] = sThunderCallDescription,
        [ABILITY_MARINE_APEX] = sMarineApexDescription,
        ...
        [ABILITY_RETRIBUTION_BLOW] = sRetributionBlowDescription,
