...
#define ABILITY_COMBAT_SPECIALIST (ABILITIES_COUNT_LATEST_GEN + 193) // Iron Fist + Striker
#define ABILITY_JUNGLES_GUARD    (ABILITIES_COUNT_LATEST_GEN + 194) // Flower Veil + Leaf Guard.
#define ABILITY_HUNTERS_HORN     (ABILITIES_COUNT_LATEST_GEN + 195) // Mighty Horn + Predator.
