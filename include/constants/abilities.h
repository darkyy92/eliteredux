...
#define ABILITY_MONKEY_BUSINESS     (ABILITIES_COUNT_LATEST_GEN + 193) // Tickle on entry.
#define ABILITY_COMBAT_SPECIALIST   (ABILITIES_COUNT_LATEST_GEN + 194) // Iron Fist + Striker
#define ABILITY_JUNGLES_GUARD       (ABILITIES_COUNT_LATEST_GEN + 195) // Flower Veil + Leaf Guard.
#define ABILITY_HUNTERS_HORN        (ABILITIES_COUNT_LATEST_GEN + 196) // Mighty Horn + Predator.
#define ABILITY_PIXIE_POWER         (ABILITIES_COUNT_LATEST_GEN + 197) // Fairy aura + illuminate
...
#define ABILITY_BERSERKER_RAGE      (ABILITIES_COUNT_LATEST_GEN + 212) // Berserk + Rampage
...
#define ABILITY_MONSTER_HUNTER      (ABILITIES_COUNT_LATEST_GEN + 259) // +50% damage vs dark types
#define ABILITY_CROWNED_SWORD       (ABILITIES_COUNT_LATEST_GEN + 260) // Intrepid Sword + Anger Point
#define ABILITY_CROWNED_SHIELD      (ABILITIES_COUNT_LATEST_GEN + 261) // Intrepid Shield + Stamina
...
#define ABILITY_COSTAR              (ABILITIES_COUNT_LATEST_GEN + 295)
#define ABILITY_COMMANDER           (ABILITIES_COUNT_LATEST_GEN + 296)
#define ABILITY_EJECT_PACK_ABILITY  (ABILITIES_COUNT_LATEST_GEN + 297)
#define ABILITY_VENGEFUL_SPIRIT     (ABILITIES_COUNT_LATEST_GEN + 298)
#define ABILITY_CUD_CHEW            (ABILITIES_COUNT_LATEST_GEN + 299)
#define ABILITY_ARMOR_TAIL          (ABILITIES_COUNT_LATEST_GEN + 300)
#define ABILITY_MIND_CRUSH          (ABILITIES_COUNT_LATEST_GEN + 301)
#define ABILITY_SUPREME_OVERLORD    (ABILITIES_COUNT_LATEST_GEN + 302)
#define ABILITY_PROTOSYNTHESIS (ABILITIES_COUNT_LATEST_GEN + 281)
#define ABILITY_QUARK_DRIVE (ABILITIES_COUNT_LATEST_GEN + 282)
#define ABILITY_GUILT_TRIP (ABILITIES_COUNT_LATEST_GEN + 292)
#define ABILITY_ILL_WILL            (ABILITIES_COUNT_LATEST_GEN + 303)
#define ABILITY_FIRE_SCALES         (ABILITIES_COUNT_LATEST_GEN + 304)
#define ABILITY_TWO_SPIKES_ON_ENTRY (ABILITIES_COUNT_LATEST_GEN + 305)
#define ABILITY_SPECIAL_VIOLENT_RUSH (ABILITIES_COUNT_LATEST_GEN + 306)
#define ABILITY_DOUBLE_IRON_BARBS   (ABILITIES_COUNT_LATEST_GEN + 307)
#define ABILITY_THERMAL_EXCHANGE    (ABILITIES_COUNT_LATEST_GEN + 308)
#define ABILITY_GOOD_AS_GOLD        (ABILITIES_COUNT_LATEST_GEN + 309)
#define ABILITY_SHARING_IS_CARING   (ABILITIES_COUNT_LATEST_GEN + 310)
#define ABILITY_TABLETS_OF_RUIN     (ABILITIES_COUNT_LATEST_GEN + 311)
#define ABILITY_SWORD_OF_RUIN       (ABILITIES_COUNT_LATEST_GEN + 312)
#define ABILITY_VESSEL_OF_RUIN      (ABILITIES_COUNT_LATEST_GEN + 313)
#define ABILITY_BEADS_OF_RUIN       (ABILITIES_COUNT_LATEST_GEN + 314)
#define ABILITY_PERMAFROST_CLONE    (ABILITIES_COUNT_LATEST_GEN + 315)
#define ABILITY_GALLANTRY           (ABILITIES_COUNT_LATEST_GEN + 316)
#define ABILITY_ORICHALCUM_PULSE    (ABILITIES_COUNT_LATEST_GEN + 317)
#define ABILITY_LEAF_GUARD_CLONE    (ABILITIES_COUNT_LATEST_GEN + 318)
#define ABILITY_WINGED_KING         (ABILITIES_COUNT_LATEST_GEN + 319)
#define ABILITY_HADRON_ENGINE       (ABILITIES_COUNT_LATEST_GEN + 320)
#define ABILITY_IRON_SERPENT        (ABILITIES_COUNT_LATEST_GEN + 321)
#define ABILITY_WEATHER_DOUBLE_BOOST (ABILITIES_COUNT_LATEST_GEN + 322)
#define ABILITY_SWEEPING_EDGE_PLUS  (ABILITIES_COUNT_LATEST_GEN + 323)
