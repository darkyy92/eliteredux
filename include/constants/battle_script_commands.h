...
#define MOVEEND_CHARGE                            22
#define MOVEEND_ATTACKER_FOLLOWUP_MOVE            23
#define MOVEEND_ABILITIES_AFTER_RECOIL            24
#define MOVEEND_EJECT_BUTTON                      25
#define MOVEEND_RED_CARD                          26
#define MOVEEND_EJECT_PACK                        27
#define MOVEEND_LIFEORB_SHELLBELL                 28
#define MOVEEND_CHANGED_ITEMS                     29
#define MOVEEND_DEFROST                           30
